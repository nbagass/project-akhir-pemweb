        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-md-12 col-xl-6 col-lg-6">
                <div class="banner-content ">
                    <span class="subheading">Sistem Informasi Universitas Brawijaya</span>
                    <h1>Welcome to SIAMSI!</h1>
                    <p class="mb-40"> SIAMSI (Sistem Informasi Akademik Mahasiswa Sistem Informasi) adalah layanan sistem informasi online untuk menginput data akademik mahasiswa program studi Sistem Informasi Universitas Brawijaya</p>

                    <div class="btn-container">
                        <a href="login" class="btn btn-main rounded">Login</a>
                        <a href="register" class="btn btn-main rounded">Register</a>
                    </div>
                </div>
            </div>
...
<section class="footer footer-3 pt-0">
			...
			<div class="row align-items-center">
                ...
                <div class="col-xl-5 col-sm-12 col-lg-6">
					<div class="footer-btm-links text-start text-sm-center text-lg-end">
						<p class="mb-0 copyright text-sm-center text-lg-start">© 2021 SIAMSI All rights reserved by <a href="" rel="nofollow">Kelompok 4</a> </p>
					</div>
				</div>
			</div>
		</div>
